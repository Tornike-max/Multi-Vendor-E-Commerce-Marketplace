...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $vendorsRole = Role::create(['name' => RolesEnum::Vendor->value]);
        ...
        $sellProdicts = Permission::create([
        ...
        $vendorsRole->syncPermissions([$sellProdicts]);
        $adminRole->syncPermissions([$sellProdicts, $buyProducts, $approveVendors]);
    }
}
